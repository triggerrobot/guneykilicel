...
export default function About() {
  const structure = [
    ...
    { title: about.trainings.title, display: about.trainings.display, items: about.trainings.courses.map((course) => course.name) },
    ...
    <Column maxWidth="m">
      ...
      <Flex fillWidth mobileDirection="column" horizontal="center">
        ...
        <Column className={styles.blockAlign} flex={9} maxWidth={40}>
          ...
          {about.trainings.display && (
            <>
              <Heading as="h2" id={about.trainings.title} variant="display-strong-s" marginBottom="m">
                {about.trainings.title}
              </Heading>
              <Column fillWidth gap="l" marginBottom="40">
                {about.trainings.courses.map((course, index) => (
                  <Column key={`${course.name}-${index}`} fillWidth gap="4">
                    <Text variant="heading-strong-l">{course.name}</Text>
